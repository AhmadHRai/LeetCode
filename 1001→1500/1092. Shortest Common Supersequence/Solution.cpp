...
/*
Approach Summary:
    This solution uses dynamic programming to find the shortest common supersequence of two strings. It first constructs a DP table to store the lengths of common 
    subsequences and then backtracks to construct the actual supersequence.

Complexity Analysis:
- Time Complexity: O(M * N), where M and N are the lengths of the input strings, because each cell in the DP table is filled once.
- Space Complexity: O(M * N), for storing the DP table and the resulting supersequence.
*/