...
/*
The time complexity of this code is O(n^2 + nlogn), where n is the length of the array, since it uses a 
sorting algorithm that takes O(nlogn) time and a two-pointer technique that takes O(n^2) time. 
The space complexity is O(n), where n is the length of the array, since it uses a recursive sorting 
algorithm that takes O(n) space and an auxiliary array that stores O(n) triplets.
 */
